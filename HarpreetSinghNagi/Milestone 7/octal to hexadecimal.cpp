...
It uses 16 symbols to represent all its numbers i.e. 0123456789ABCDEF
...
//binary to octal values {0, 1, 2 , 3 ,  4 ,  5 ,  6 ,  7 }

    long long octal, i, binary, place;
    int ld=0, digit, n, j, rev=0, revld=0;
