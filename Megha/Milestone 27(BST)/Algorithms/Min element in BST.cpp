...
//Iterative solution to find minimum element
...
//Recursive solution to find minimum element
...
int main() {
    ...
    cout<<"Iterative solution minimum element is "<<minIterative(root)<<endl;
    cout<<"Recursive solution minimum element is "<<minRecursive(root);
