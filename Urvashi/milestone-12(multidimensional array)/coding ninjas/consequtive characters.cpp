//question-17(consequtive chars):-Given a matrix of characters..
// Find length of the longest path from a given character(a list of such characters will be given),
