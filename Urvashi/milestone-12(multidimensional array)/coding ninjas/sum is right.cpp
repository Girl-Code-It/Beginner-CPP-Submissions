//question-1(sum is right):-Given a n x m matrix of integers,
// replace every element with sum of elements present on its right excluding current element (in current row
// only).
