#include<bits/stdc++.h>
using namespace std;
int main()              //question: we have to input the no of passwords choices . and passwords .
{                      // now we have to print the middle chracter and length of that password whose reverse is also present in the choices .
int t,l,d;
cin>>t;
string s[t];
